...
<article id="post-<?php echo $td_mod_single->post->ID;?>" class="<?php echo join(' ', get_post_class('td-post-template-rd-11'));?>" <?php echo $td_mod_single->get_item_scope();?>>
    ...
    <div class="td-full-screen-header-image-wrap td-container-wrap">
        ...
        <div id="td-full-screen-header-image">
                    ...
                    default: //sidebar right
                        ...
                        <div class="td-pb-span8 td-main-content" role="main">
                            <div class="td-ss-main-content">
                                <?php
                                require_once('loop-single-rd-11.php');

<?php
class td_smart_list_rd_2 extends td_smart_list {
    ...
    protected function render_before_list_wrap() {
        ...
        $buffy .= '<div class="td_smart_list_rd_2' . $td_class_nr_of_columns . '">';
    ...
    protected function render_list_item($item_array, $current_item_id, $current_item_number, $total_items_number) {
        ...
        //get the title
        $smart_list_rd_2_title = '';
        if(!empty($item_array['title'])) {
            $smart_list_rd_2_title = $item_array['title'];
        }
        ...
        //title
        $buffy .= '<div class="td-number-and-title"><h2 class="td-sml-current-item-title">' . $smart_list_rd_2_title . '</h2></div>';
    ...
    protected function render_after_list_wrap() {
        $buffy = '';
        $buffy .= '</div>'; // /.td_smart_list_rd_2  wrapper with id

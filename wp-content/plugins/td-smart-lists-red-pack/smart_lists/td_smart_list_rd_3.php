...
class td_smart_list_rd_3 extends td_smart_list {
    ...
    protected function render_before_list_wrap() {
        ...
        $buffy .= '<div class="td_smart_list_rd_3' . $td_class_nr_of_columns . '">';
    ...
    protected function render_list_item($item_array, $current_item_id, $current_item_number, $total_items_number) {
        ...
        //get the title
        $smart_list_rd_3_title = '';
        if(!empty($item_array['title'])) {
            $smart_list_rd_3_title = $item_array['title'];
        }
        ...
        $buffy .= '<div class="td-number-and-title"><h2 class="td-sml-current-item-title">' . $current_item_number . '. ' . $smart_list_rd_3_title . '</h2></div>';
        ...
        // ad smart list
        $tds_smart_list_title = td_util::get_option('tds_smart_list_rd_3_title'); // ad title
        $buffy .= td_global_blocks::get_instance('td_block_ad_box')->render(array('spot_id' => 'smart_list_rd_3', 'spot_title' => $tds_smart_list_title));
        ...
        if (!empty($first_img_info[0])) {
            ...
            $buffy .= '
                <div class="td-sml-figure">
                    <figure class="td-slide-smart-list-figure td-slide-smart-list-rd-3' . $smart_list_lightbox . '">
    ...
    protected function render_after_list_wrap() {
        $buffy = '';
        $buffy .= '</div>'; // /.td_smart_list_rd_3  wrapper with id

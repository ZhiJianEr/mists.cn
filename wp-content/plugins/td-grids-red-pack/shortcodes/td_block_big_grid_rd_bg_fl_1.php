 ...
 */
class td_block_big_grid_rd_bg_fl_1 extends td_block {
    ...
    function render($atts, $content = null){
        ...
        $buffy .= '<div class="' . $this->get_block_classes(array($td_grid_style, 'td-hover-1 td-big-grids td-big-gr-grids td-big-grids-fl')) . '" ' . $this->get_block_html_atts() . '>';
            //get the block css
    ...
    function inner($posts, $td_column_number = '') {
        ...
        if (!empty($posts)) {
            ...
            if ($td_column_number==1 || $td_column_number==2) {
                $buffy .= td_util::get_block_error('Big grid red full 1', 'Please move this shortcode on a full row in order for it to work.');
            } else {
                ...
                if ($post_count < self::POST_LIMIT) {
                    ...
                    for ($i = $post_count; $i < self::POST_LIMIT; $i++) {
                        ...
                        $buffy .= $td_module_mx_empty->render($i, 'td_module_mx_rd_bg_23'); // module used

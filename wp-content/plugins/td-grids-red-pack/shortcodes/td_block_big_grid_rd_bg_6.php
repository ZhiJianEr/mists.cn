 ...
 */
class td_block_big_grid_rd_bg_6 extends td_block {
    ...
    function inner($posts, $td_column_number = '') {
        ...
        if (!empty($posts)) {
            ...
            if ($td_column_number==1 || $td_column_number==2) {
                $buffy .= td_util::get_block_error('Big grid red 6', 'Please move this shortcode on a full row in order for it to work.');
            } else {

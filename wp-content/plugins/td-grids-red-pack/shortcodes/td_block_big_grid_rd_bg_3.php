 ...
 */
class td_block_big_grid_rd_bg_3 extends td_block {
    ...
    function inner($posts, $td_column_number = '') {
        ...
        if (!empty($posts)) {
            ...
            if ($td_column_number==1 || $td_column_number==2) {
                $buffy .= td_util::get_block_error('Big grid red 3', 'Please move this shortcode on a full row in order for it to work.');
            } else {
                ...
                foreach ($posts as $post) {
                    ...
                    if ($post_count < 3) {
                        $td_module_mx_rd_bg_6 = new td_module_mx_rd_bg_6($post);
                        $buffy .= $td_module_mx_rd_bg_6->render($post_count);

                        $post_count++;
                        continue;
                    }

                    $td_module_mx_rd_bg_7 = new td_module_mx_rd_bg_7($post);
                    $buffy .= $td_module_mx_rd_bg_7->render($post_count);
                ...
                if ($post_count < self::POST_LIMIT) {
                    ...
                    for ($i = $post_count; $i < self::POST_LIMIT; $i++) {
                        ...
                        if ($post_count < 3) {
                            ...
                            $buffy .= $td_module_mx_empty->render($i, 'td_module_mx_rd_bg_6');
                        ...
                        $td_module_mx_empty = new td_module_mx_empty();
                        $buffy .= $td_module_mx_empty->render($i, 'td_module_mx_rd_bg_7');

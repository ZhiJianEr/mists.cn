 ...
 */
class td_block_big_grid_rd_bg_14 extends td_block {
    ...
    function inner($posts, $td_column_number = '') {
        ...
        if (!empty($posts)) {
            ...
            if ($td_column_number==1 || $td_column_number==2) {
                $buffy .= td_util::get_block_error('Big grid red 14', 'Please move this shortcode on a full row in order for it to work.');
            } else {
                ...
                foreach ($posts as $post) {
                    ...
                    if ($post_count < 2) {
                        $td_module_mx_rd_bg_19 = new td_module_mx_rd_bg_19($post);
                        $buffy .= $td_module_mx_rd_bg_19->render($post_count);
                    ...
                    if ($post_count == 2) {
                        $td_module_mx_rd_bg_18 = new td_module_mx_rd_bg_18($post);
                        $buffy .= $td_module_mx_rd_bg_18->render($post_count);
                        $post_count++;
                        continue;
                    }
                ...
                if ($post_count < self::POST_LIMIT) {
                    ...
                    for ($i = $post_count; $i < self::POST_LIMIT; $i++) {
                        ...
                        if ($post_count < 2) {
                            ...
                            $buffy .= $td_module_mx_empty->render($i, 'td_module_mx_rd_bg_19');
                        ...
                        if ($post_count == 2) {
                            $td_module_mx_empty = new td_module_mx_empty();
                            $buffy .= $td_module_mx_empty->render($i, 'td_module_mx_rd_bg_18');
                            $post_count++;
                            continue;
                        }

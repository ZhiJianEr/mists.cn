...
class td_module_mx_rd_bg_20 extends td_module {
        ...
        <div class="<?php echo $this->get_module_classes(array("td-big-grid-post-$order_no", "td-big-grid-post td-mx-19"));?>">
            <?php if($position==1) { ?>
                <div class="td-module-image">
                    <?php echo $this->get_image('td_490x245');?>
                </div>
            <?php } ?>

            <div class="td-item-details-wrap td-category-small">
                <div class="td-item-details">
                    <?php if (td_util::get_option('tds_category_module_mx_rd_bg_20') == 'yes') { echo $this->get_category(); }?>
